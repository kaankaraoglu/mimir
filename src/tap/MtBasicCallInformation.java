...
public class MtBasicCallInformation implements Serializable {
	...
	public CallOriginator callOriginator = null;
	...
	public MtBasicCallInformation(ChargeableSubscriber chargeableSubscriber, RapFileSequenceNumber rapFileSequenceNumber, CallOriginator callOriginator, OriginatingNetwork originatingNetwork, CallEventStartTimeStamp callEventStartTimeStamp, TotalCallEventDuration totalCallEventDuration, SimToolkitIndicator simToolkitIndicator, CauseForTerm causeForTerm) {
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (callOriginator != null) {
			codeLength += callOriginator.encode(os, true);
		}
