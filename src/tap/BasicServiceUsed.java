...
public class BasicServiceUsed implements Serializable {
	...
	public HSCSDIndicator hSCSDIndicator = null;
	...
	public BasicServiceUsed(BasicService basicService, ChargingTimeStamp chargingTimeStamp, ChargeInformationList chargeInformationList, HSCSDIndicator hSCSDIndicator) {
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (hSCSDIndicator != null) {
			codeLength += hSCSDIndicator.encode(os, true);
		}
		...
		if (basicService != null) {
			codeLength += basicService.encode(os, true);
		}
