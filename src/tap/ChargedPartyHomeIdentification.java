...
public class ChargedPartyHomeIdentification implements Serializable {
	...
	public ChargedPartyHomeIdentification(HomeIdType homeIdType, HomeIdentifier homeIdentifier) {
