...
public class ChargedParty implements Serializable {
	...
	public PublicUserId publicUserId = null;
	public HomeBid homeBid = null;
	public HomeLocationDescription homeLocationDescription = null;
	...
	public ChargedParty(Imsi imsi, Msisdn msisdn, PublicUserId publicUserId, HomeBid homeBid, HomeLocationDescription homeLocationDescription, Imei imei) {
		this.imsi = imsi;
		this.msisdn = msisdn;
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (homeLocationDescription != null) {
			codeLength += homeLocationDescription.encode(os, true);
		}
		
		if (homeBid != null) {
			codeLength += homeBid.encode(os, true);
		}
		
		if (publicUserId != null) {
			codeLength += publicUserId.encode(os, true);
		}
