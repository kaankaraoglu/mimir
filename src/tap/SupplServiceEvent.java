...
public class SupplServiceEvent implements Serializable {
	...
	public SupplServiceUsed supplServiceUsed = null;
	...
	public SupplServiceEvent(ChargeableSubscriber chargeableSubscriber, RapFileSequenceNumber rapFileSequenceNumber, LocationInformation locationInformation, ImeiOrEsn equipmentIdentifier, SupplServiceUsed supplServiceUsed, OperatorSpecInfoList operatorSpecInformation) {
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (supplServiceUsed != null) {
			codeLength += supplServiceUsed.encode(os, true);
		}
