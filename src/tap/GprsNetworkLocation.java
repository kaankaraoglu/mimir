...
public class GprsNetworkLocation implements Serializable {
	...
	public RecEntityCodeList recEntity = null;
	...
	public GprsNetworkLocation(RecEntityCodeList recEntity, LocationArea locationArea, CellId cellId) {
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (recEntity != null) {
			codeLength += recEntity.encode(os, true);
		}
