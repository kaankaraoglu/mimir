...
public class SessionChargeInfoList implements Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.CONSTRUCTED, 448);
	public byte[] code = null;
	public List<SessionChargeInformation> seqOf = null;
	...
	public SessionChargeInfoList(List<SessionChargeInformation> seqOf) {
		this.seqOf = seqOf;
	}
