...
public class Notification implements Serializable {
	...
	public Notification(Sender sender, Recipient recipient, FileSequenceNumber fileSequenceNumber, RapFileSequenceNumber rapFileSequenceNumber, FileCreationTimeStamp fileCreationTimeStamp, FileAvailableTimeStamp fileAvailableTimeStamp, TransferCutOffTimeStamp transferCutOffTimeStamp, SpecificationVersionNumber specificationVersionNumber, ReleaseVersionNumber releaseVersionNumber, FileTypeIndicator fileTypeIndicator, OperatorSpecInfoList operatorSpecInformation) {
		this.sender = sender;
