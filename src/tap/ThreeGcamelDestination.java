...
public class ThreeGcamelDestination implements Serializable {
	...
	public CamelDestinationNumber camelDestinationNumber = null;
	...
	public ThreeGcamelDestination(CamelDestinationNumber camelDestinationNumber, GprsDestination gprsDestination) {
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (camelDestinationNumber != null) {
			codeLength += camelDestinationNumber.encode(os, true);
			codeLength += BerLength.encodeLength(os, codeLength);
			if (withTag) {
				codeLength += tag.encode(os);
			}
