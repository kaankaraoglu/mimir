...
public class LocationInformation implements Serializable {
	...
	public NetworkLocation networkLocation = null;
	...
	public LocationInformation(NetworkLocation networkLocation, HomeLocationInformation homeLocationInformation, GeographicalLocation geographicalLocation) {
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (networkLocation != null) {
			codeLength += networkLocation.encode(os, true);
		}
