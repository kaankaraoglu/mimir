...
public class MessageDescriptionInfoList implements Serializable {

	private static final long serialVersionUID = 1L;

	public static final BerTag tag = new BerTag(BerTag.APPLICATION_CLASS, BerTag.CONSTRUCTED, 8);
	public byte[] code = null;
	public List<MessageDescriptionInformation> seqOf = null;
	...
	public MessageDescriptionInfoList(List<MessageDescriptionInformation> seqOf) {
		this.seqOf = seqOf;
	}
